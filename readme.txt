=== The Events Calendar Extension: Google Maps Geocoding ===
...
Make your imports use local Google Maps geocoding on events and venues. This will use your API key to do these lookups.

*Note: this may incur additional charges from Google Maps*

== Description ==

When doing imports, use your local Google Maps API key for geocoding of events and venues.
